    ...
    */
	...
	protected function _buildtrdir($dir,$currentdir,$filesize,$filetime,$id){
		$tr = '<tr bgcolor="#FFFFFF" overstyle="on" align="left" id="line_'.$id.'">
				   ...
				   <img src="/Style/A/images/ico/dir.png" width="20px" height="20px"align="absbottom">'.$dir.'</a>
				   </td>
				   <td> </td>
	...
	protected function _buildtrfile($file,$currentdir,$filesize,$filetime,$id){
		...
		$tr = '<tr bgcolor="#FFFFFF" overstyle="on" align="left" id="line_'.$id.'">
				   <td>
				   <img src="/Style/A/images/ico/'.$ico.'" width="20px" height="20px"align="absbottom">'.$file.'
				   </td>
	...
	protected function _listdirfile(){
		...
		while(($file = $dh->read())!== false)
		{
			...
			if($file == ".")
			{
				...
				$dirs[] = '<tr overstyle="on" align="left"><td bgcolor="#ffffff"><a href="__URL__?newpath='.$updir.'" target="_self"><img src="/Style/A/images/ico/up.png" align="absbottom" width="20px" height="20px" />上级目录</a></td><td colspan="3" bgcolor="#ffffff">当前目录:'.$currentdir."</td></tr>";
	...
	protected function _ListDir($dir="",$id)
	{
		...
		while (false !== ($entry = $Ld->read())) {
			...
			if (is_dir($checkdir)&&!preg_match("[^\.]",$entry)){
			   ...
			   $list.="<li><span class='listdirimg diron' data='/".$checkdir."/'>&nbsp;</span><img src='/Style/A/images/ico/dir.png' width='20px' height='20px' align='absbottom' data='/".$checkdir."/'>".$entry."</li>\r\n";
			}else{
