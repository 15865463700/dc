...
$acl_inc[$i]['low_leve']['appmanager'] = array("app管理" => array(
    "查看" => "appm1",
    "编辑" => "appm2",
    "上传" => "appm3",
),
    "data" => array(
        "eqaction_banner" => "appm1",
        "eqaction_bannersave" => "appm2",
        "eqaction_swfupload" => "appm3",
        "eqaction_more" => "appm1",
        "eqaction_moresave" => "appm2",
        "eqaction_erweima" => "appm1",
        "eqaction_erweimasave" => "appm2",
    )
);
...
$acl_inc[$i]['low_leve']['withdrawlogwait'] = array("待提现列表" => array(
    ...
    "data" => array(
        ...
        'eqaction_index' => 'cg4',
        'eqaction_edit' => 'cg5',
        'eqaction_checkip' => 'cg4',
        'eqaction_doedit' => 'cg5',
        'eqaction_duizhang' => 'cg5',
        'eqaction_duizhangedit' => 'cg5',
...
$acl_inc[$i]['low_leve']['withdrawloging'] = array("提现处理中列表" => array(
    ...
    "data" => array(
        ...
        'eqaction_edit' => 'cg7',
        'eqaction_doedit' => 'cg7',
        'eqaction_duizhang' => 'cg7',
        'eqaction_duizhangedit' => 'cg7',
    )
);
...
$acl_inc[$i]['low_leve']['capitalaccount'] = array("会员账户" => array(
    "列表" => 'capital_1',
    "导出" => 'capital_2',
),
    "data" => array(
...
$acl_inc[$i]['low_leve']['capitalall'] = array("网站资金统计" => array(
    ...
    "data" => array(
        ...
        'eqaction_iolist' => 'capital_9',
        'eqaction_export' => 'capital_9',
    )
);
//权限管理
$i++;
...
$acl_inc[$i]['low_leve']['id5'] = array("id5实名认证" => array(
    "id5认证" => 'id5',
),
    "data" => array(
        'eqaction_index' => 'id5',
...
$i++;
$acl_inc[$i]['low_title'][] = '营销管理';
$acl_inc[$i]['low_leve']['redpacket'] = array("红包管理" => array(
    "列表" => "rpk1",
    "添加" => "rpk2",
    "修改" => "rpk3",
    "删除" => "rpk5",
...
$acl_inc[$i]['low_leve']['interestratecoupon'] = array("加息券管理" => array(
    ...
    "data" => array(
        ...
        'eqaction_couponlog' => 'irc1',
        "eqaction_add" => "irc2",
        'eqaction_sendpage' => 'irc1',
        'eqaction_sendcoupon' => 'irc2',
    )
);
$acl_inc[$i]['low_leve']['privilege'] = array("特权金管理" => array(
    "查看" => "pri1",
    "编辑" => "pri2",
    "删除" => "pri3",
),
...
//18-02-07 企业认证
$i++;
$acl_inc[$i]['low_title'][] = "企业认证管理";
$acl_inc[$i]['low_leve']['verifybusiness'] = array("企业认证会员" => array(
    "列表" => 'vbusiness1',
    "审核" => 'vbusiness2',
),
    "data" => array(
        //网站设置
        'eqaction_index' => 'vbusiness1',
        'eqaction_edit' => 'vbusiness2',
        'eqaction_doedit' => 'vbusiness2',
    )
);

//18-03-12 提现审核密码
$i++;
$acl_inc[$i]['low_title'][] = "提现审核密码";
$acl_inc[$i]['low_leve']['verifywithdrawlogwait'] = array("提现审核密码" => array(
    "设置" => 'vWD1',
    "修改" => 'vWD2',
),
    "data" => array(
        //网站设置
        'eqaction_index' => 'vWD1',
        'eqaction_doedit' => 'vWD2',
        'eqaction_verifypass' => 'vWD1', // 输入密码页面       新增加2018-03-12
        'eqaction_doverify' => 'vWD1', // 验证密码       新增加2018-03-12
        'eqaction_clearverify' => 'vWD1', // 清空密码缓存       新增加2018-03-12
    )
);
?>