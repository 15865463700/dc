...
function LeftRotateLong($lValue, $lBits) //��λ���ƺ���
{
    $lngSign = 0;
    $intI = 0;
    $mValue = 0;
...
function RightRotateLong($lValue, $lBits) //��λ���ƺ���
{
    $lngSign = 0;
    $intI = 0;
    $mValue = 0;
...
function Encode($b, &$outb, $Key) //��ǿ�㷨--����
{
    $keybuf[] = 0;
    $v[] = 0;
    $k[] = 0;
...
function Decode($b, &$outb, $Key) //��ǿ�㷨--����
{
    $keybuf[] = 0;
    $v[] = 0;
    $k[] = 0;
...
function StrDec($InString, $Key) //ʹ����ǿ�㷨�������ַ���
{
    $b[] = 0;
    $outb[] = 0;
    $temp[] = 0;
