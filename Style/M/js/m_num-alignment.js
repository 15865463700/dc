(function($){ 
	var functions = {
		init:function(input, step, max, min, digit){
			...
			//添加左右加减号
			input.wrap("<div style = 'overflow:hidden;width:" + width + "px;height:" + height + "px; position:absolute; top:8.2rem; left:48%;'></div>");
			input.before("<div id = '" + input.attr('id') + "l'  onselectstart = 'return false;' style = '-moz-user-select:none;cursor:pointer;text-align:center;width:" + height + "px;height:" + height + "px;line-height:" + height + "px;background-color:#f0f0f0;float:left;font-size:40px;color:#989898; -moz-border-radius:8px; -webkit-border-radius:8px; border-radius:8px;'>-</div>");
			input.after("<div id = '" + input.attr('id') + "r'  onselectstart = 'return false;' style = '-moz-user-select:none;cursor:pointer;text-align:center;width:" + height + "px;height:" + height + "px;line-height:" + height + "px;background-color:#f0f0f0;float:right;font-size:35px;color:#989898; -moz-border-radius:8px; -webkit-border-radius:8px; border-radius:8px;'> + </div>");
			//左右调用执行
