...
function return_url($code, $is_api = 0){
	if($is_api){
		//return C('site_url').'/index.php?g=Member&m=Respond&a=respond_post&payid='.$code;
		return C('site_url').'/index.php/user'.C('URL_PATHINFO_DEPR').'Respond'.C('URL_PATHINFO_DEPR').'respond_post'.C('URL_PATHINFO_DEPR').'payid'.C('URL_PATHINFO_DEPR').$code;
	}
	else {
		//return C('site_url').'/index.php?g=Member&m=Respond&a=respond_get&payid='.$code;
		return C('site_url').'/index.php/user'.C('URL_PATHINFO_DEPR').'Respond'.C('URL_PATHINFO_DEPR').'respond_get'.C('URL_PATHINFO_DEPR').'payid'.C('URL_PATHINFO_DEPR').$code;
	}
}
