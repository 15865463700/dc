/* This file is created by DBReback 1508414930 */ 
 /* 数据表结构 `shang_acl`*/ 
 ...
 /* 插入数据 `shang_ad` */
 INSERT INTO `shang_ad` VALUES ('1','<img style=\"float:none;margin:0px;\" alt=\"\" src=\"/Static/Uploads/Article/20171002073257.png\" />','1403082675','1403082675','1403082675','LOGO（350*48像素）','0');/* DBReback Separation */
 /* 插入数据 `shang_ad` */
 ...
 /* 插入数据 `shang_ad` */
 INSERT INTO `shang_ad` VALUES ('4','a:1:{i:0;a:3:{s:3:\"img\";s:39:\"Static/Uploads/Ad/20170927084427422.jpg\";s:4:\"info\";s:0:\"\";s:3:\"url\";s:0:\"\";}}','1403082675','1403082675','1403082675','首页——滚动图（1960*440像素）','1');/* DBReback Separation */
 /* 插入数据 `shang_ad` */
 ...
 /* 插入数据 `shang_ad` */
 INSERT INTO `shang_ad` VALUES ('8','<img style=\"float:none;margin:0px;\" alt=\"\" src=\"/Static/Uploads/Article/20171002160442.png\" />','0','0','1403082675','首页——底部——二维码右','0');/* DBReback Separation */
 /* 插入数据 `shang_ad` */
 ...
 /* 插入数据 `shang_ad` */
 INSERT INTO `shang_ad` VALUES ('9','<img style=\"float:none;margin:0px;\" alt=\"\" src=\"/Static/Uploads/Article/20171002160332.png\" />','0','0','1403082675','首页——底部——二维码左','0');/* DBReback Separation */
 /* 插入数据 `shang_ad` */
 ...
 /* 插入数据 `shang_ad` */
 INSERT INTO `shang_ad` VALUES ('29','<img alt=\"\" style=\"float:none;margin:0px;\" src=\"/Static/Uploads/Article/20170927085149.jpg\" />','0','0','1445827127','我要借款——头部（1200*122像素）','0');/* DBReback Separation */
 /* 插入数据 `shang_ad` */
 ...
 /* 插入数据 `shang_ad` */
 INSERT INTO `shang_ad` VALUES ('32','a:1:{i:0;a:3:{s:3:\"img\";s:39:\"Static/Uploads/Ad/20170927100646896.jpg\";s:4:\"info\";s:0:\"\";s:3:\"url\";s:0:\"\";}}','0','0','1446452590','微信端--首页--轮播图','1');/* DBReback Separation */
 /* 插入数据 `shang_ad` */
 ...
 CREATE TABLE `shang_article` (
  ...
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`)
) ENGINE=MyISAM AUTO_INCREMENT=274 DEFAULT CHARSET=utf8;/* DBReback Separation */
 /* 插入数据 `shang_article` */
 ...
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('10','公司简介','','','','<p>qweqwe</p>','30','0','8','intro','0','1389931247','0','article','1');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('11','运营团队','','','','<p><span style=\"font-family: simhei;\">山东团尚</span></p><p><span style=\"font-family: lisu;\">山东团尚</span></p><p><span style=\"font-family: simsun;\">山东团尚</span></p><p><span style=\"font-family: georgia;\">山东团尚</span></p><p><span style=\"font-family: verdana;\">山东团尚</span></p>','20','0','8','team','0','1389931315','0','article','1');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('16','资费说明','','','','','7','0','8','tariff','0','1389940055','0','article','0');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('17','政策法规','','','','','8','1','8','policy','0','1389940204','0','article','0');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('24','专家顾问','','','','','10','0','8','expert','0','1414225350','0','article','0');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('25','合作伙伴','','','','','9','0','8','partner','0','1414287385','0','article','0');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('26','联系我们','','','','','0','0','8','contact','0','1414287474','0','article','0');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('27','招贤纳士','','','','','7','0','8','invite','0','1414287514','0','article','0');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
 ...
 /* 插入数据 `shang_article_category` */
 INSERT INTO `shang_article_category` VALUES ('50','安全保障','','','','','0','0','8','baozhang','0','1446195126','0','article','0');/* DBReback Separation */
 /* 插入数据 `shang_article_category` */
...
) ENGINE=MyISAM AUTO_INCREMENT=140 DEFAULT CHARSET=utf8;/* DBReback Separation */
 /* 插入数据 `shang_ausers` */
 ...
 /* 插入数据 `shang_ausers` */
 INSERT INTO `shang_ausers` VALUES ('139','zerunadmin','0192023a7bbd73250516f069df18b500','5','','1508414898','127.0.0.1','0','0','中国','0','','','','');/* DBReback Separation */ 
 ...
 /* 数据表结构 `shang_borrow_expired`*/ 
 DROP TABLE IF EXISTS `shang_borrow_expired`;/* DBReback Separation */ 
 CREATE TABLE `shang_borrow_expired` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `borrow_id` int(11) NOT NULL COMMENT '标号',
  `expired_money` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT '逾期罚息',
  `expired_days` smallint(5) NOT NULL DEFAULT '0',
  `call_fee` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT '催收费',
  `sort_order` tinyint(3) NOT NULL COMMENT '还款期数',
  `add_time` int(10) NOT NULL COMMENT '还款时间',
  `add_ip` varchar(20) NOT NULL COMMENT '还款ip',
  `uid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
 ...
 CREATE TABLE `shang_borrow_info` (
  ...
  `is_new` tinyint(2) NOT NULL DEFAULT '0' COMMENT '是否为新手标:0-否,1-是',
 ...
 /* 数据表结构 `shang_borrow_repay_info`*/ 
 DROP TABLE IF EXISTS `shang_borrow_repay_info`;/* DBReback Separation */ 
 CREATE TABLE `shang_borrow_repay_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `repay_num` int(11) NOT NULL DEFAULT '0' COMMENT '还款次数',
  `uid` int(11) NOT NULL DEFAULT '0' COMMENT '用户id',
  `advance_num` int(11) NOT NULL DEFAULT '0' COMMENT '提前还款次数',
  `exporid_num` int(11) NOT NULL DEFAULT '0' COMMENT '逾期还款次数',
  `late_num` int(11) NOT NULL DEFAULT '0' COMMENT '迟还次数',
  `web_num` int(11) NOT NULL DEFAULT '0' COMMENT '网站代还次数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/* DBReback Separation */ 
 /* 数据表结构 `shang_borrow_substitute_log`*/ 
 DROP TABLE IF EXISTS `shang_borrow_substitute_log`;/* DBReback Separation */ 
 CREATE TABLE `shang_borrow_substitute_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `admin_uname` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/* DBReback Separation */ 
 ...
 /* 插入数据 `shang_global` */
 INSERT INTO `shang_global` VALUES ('20','textarea','润泽e贷','网站关键词','在首页的keywords中显示','118','web_keywords','1','1');/* DBReback Separation */
 /* 插入数据 `shang_global` */
 INSERT INTO `shang_global` VALUES ('21','textarea','润泽e贷','网站描述','在网站首页的描述中显示','117','web_descript','1','1');/* DBReback Separation */
 /* 插入数据 `shang_global` */
 ...
 /* 插入数据 `shang_global` */
 INSERT INTO `shang_global` VALUES ('19','input','润泽e贷','网站名称','出现在每个页面的title后面','120','web_name','1','1');/* DBReback Separation */
 /* 插入数据 `shang_global` */
 INSERT INTO `shang_global` VALUES ('27','input','润泽e贷','网站标题','首页标题','119','index_title','1','1');/* DBReback Separation */
 /* 插入数据 `shang_global` */
 INSERT INTO `shang_global` VALUES ('56','textarea','鲁ICP备14027736号<br/>
青岛润泽顺融商务咨询服务有限公司<br/>
© 2015 p2p网贷交易平台 All rights reserved<br/>
地址：山东省青岛市黄岛区双珠路58号
...
','网站底部','网站底部的版权和联系信息','116','bottom','1','1');/* DBReback Separation */
 ...
 /* 插入数据 `shang_global` */
 INSERT INTO `shang_global` VALUES ('73','input','1|2','催收费','逾期以后的催收费,(30|2)表示逾期30天以后开始算每天千分之2的催收费','115','fee_call','1','1');/* DBReback Separation */
 /* 插入数据 `shang_global` */
 ...
 /* 插入数据 `shang_global` */
 INSERT INTO `shang_global` VALUES ('64','input','10|5-50','提现手续费','以10-50|0-0|3-30的形式填入，数字从左到右依次表示超出回款资金总额的每笔收取总额的千分之10作为手续费,最大手续费上限50元;提现在回款总金额内的每笔收费千分之0元，手续费上限0元;单日单笔提现上限3万,单日提现资金上限30万;如果填写形式为10|5-50,表示体现手续费为10元,单笔体现限额为5万,单日提现资金上限50万;','115','fee_tqtx','1','1');/* DBReback Separation */
 /* 插入数据 `shang_global` */
 ...
 /* 插入数据 `shang_global` */
 INSERT INTO `shang_global` VALUES ('93','input','2','邀请下线奖励','填入整数，如2表示千分之二,即你所邀请的下线每投标成功一次，您可获得千分之二的奖励','0','award_invest','1','1');/* DBReback Separation */
 /* 插入数据 `shang_global` */
 ...
 /* 数据表结构 `shang_invest_debt`*/ 
 DROP TABLE IF EXISTS `shang_invest_debt`;/* DBReback Separation */ 
 CREATE TABLE `shang_invest_debt` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `ip` char(19) NOT NULL,
  `capital` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT '转让本金',
  `interest` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT '转让利息',
  `borrow_id` int(10) NOT NULL COMMENT '标号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;/* DBReback Separation */ 
 ...
 /* 插入数据 `shang_navigation` */
 INSERT INTO `shang_navigation` VALUES ('51','优计划','/fund/index','','','','8','2','2','','0','1402711350','0','navigation');/* DBReback Separation */
 /* 插入数据 `shang_navigation` */
